                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select name="location_id" id="location"
                                        class="select2 form-control form-control-sm @error('location_id') is-invalid red-border @enderror"
                                ...
                                <div class="form-group col">
                                    ...
                                    <select name="area_id" id="area"
                                        class="select2 form-control form-control-sm @error('area_id') is-invalid red-border @enderror">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <input id="opening_time" type="text" name="opening_time"
                                        class="form-control form-control-sm timepicker @error('opening_time') is-invalid @enderror"
