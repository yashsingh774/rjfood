        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.shop.products.store', $shop) }}" method="POST">
                        @csrf
                        ...
                        <div class="row" id="single-product">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="unit_price" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price') }}">
                                    @error('unit_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
